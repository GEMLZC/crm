            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <@shiro.hasPermission name="department:list">
                        <li name="department"><a href="/dept/list.do"><i class="fa fa-circle-o"></i> 部门管理</a></li>
                    </@shiro.hasPermission>
                    <@shiro.hasPermission name="employee:list">
                        <li name="employee"><a href="/emp/list.do"><i class="fa fa-circle-o"></i> 员工管理</a></li>
                    </@shiro.hasPermission>
                    ...
                    <#--<li name="role"><a href="/class/list.do"><i class="fa fa-circle-o"></i> 班级管理</a></li>-->
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
            ...
            <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    ...
                    <li name="normalCustomer"><a href="/normalCustomer/list.do"><i class="fa fa-circle-o"></i> 正式客户</a></li>
